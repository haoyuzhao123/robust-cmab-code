...
class simulateOnlineData:
    ...
    def showResult(self):
        ...
        f, axa = plt.subplots(1, sharex=True)
        axa.plot(self.tim_, algorithms['CUCB_Attack'].totalCost, label = 'CUCB_Attack')
        axa.legend(loc='upper left',prop={'size':9})
        axa.set_xlabel("Iteration")
        axa.set_ylabel("Cost")
        ...
        # plot basearm played
        f, axa = plt.subplots(1, sharex=True)
        axa.plot(self.tim_, algorithms['CUCB_Attack'].num_basearm_played, label = 'CUCB_Attack')
        axa.legend(loc='upper left',prop={'size':9})
        axa.set_xlabel("Iteration")
        ...
        f, axa = plt.subplots(1, sharex=True)
        axa.plot(self.tim_, algorithms['CUCB_Attack'].num_targetarm_played, label = 'CUCB_Attack')
        axa.legend(loc='upper left',prop={'size':9})
        axa.set_xlabel("Iteration")
